      ...
      <Row>
        <Col md={{ span: 8, offset: 2 }} className='pt-5'>
          <ul className='banner-list list-unstyled text-center'>
            <Fade>
              <li><h1><span className={`${css({ color: colors.green , fontSize: 'calc(16px + 4vw)'})}`}>You</span> are amazing.</h1></li>
            </Fade>
            <Fade delay={1500}>
              <li><h1><span className={`${css({ color: colors.green, fontSize:'calc(16px + 4vw)' })}`}>Your body</span> is amazing.</h1></li>
            </Fade>
            <Fade delay={3000}>
